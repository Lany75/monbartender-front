...
describe('<CocktailAddIngredients />', () => {
  let realUseContext;
  beforeEach(() => {
  ...
  const cocktailAddIngredients = shallow(<CocktailAddIngredients />);
  const divCocktailAddIngredients = cocktailAddIngredients.find('div.cocktail-add-ingredients');

  it('should contain a div with className="cocktail-add-ingredients"', () => {
    expect(divCocktailAddIngredients).to.have.length(1);
  })

  const cocktailAddIngredientsList = divCocktailAddIngredients.find('div.cocktail-add-ingredients-list')

  it('should contain a div with className="cocktail-add-ingredients-list"', () => {
    expect(cocktailAddIngredientsList).to.have.length(1);
  })

  it('should contain a DataGrid component with rows and columns attributes', () => {
    const dataGrid = cocktailAddIngredientsList.find(DataGrid);
  ...
  const addDeleteIngredients = divCocktailAddIngredients.find('div.add-delete-ingredients')
  ...
  const dialogs = divCocktailAddIngredients.find(Dialog);
